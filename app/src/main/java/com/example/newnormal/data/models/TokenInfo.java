...
public class TokenInfo implements Parcelable {
    ...
    public static final Creator<TokenInfo> CREATOR = new Creator<TokenInfo>() {
        @Override
        public com.example.newnormal.data.models.TokenInfo createFromParcel(Parcel in) {
            return new com.example.newnormal.data.models.TokenInfo(in);
        }

        @Override
        public com.example.newnormal.data.models.TokenInfo[] newArray(int size) {
            return new com.example.newnormal.data.models.TokenInfo[size];
        }
    };

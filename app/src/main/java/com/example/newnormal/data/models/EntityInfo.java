...
public class EntityInfo implements Parcelable {
    ...
    public static final Creator<EntityInfo> CREATOR = new Creator<EntityInfo>() {
        @Override
        public com.example.newnormal.data.models.EntityInfo createFromParcel(Parcel in) {
            return new com.example.newnormal.data.models.EntityInfo(in);
        }

        @Override
        public com.example.newnormal.data.models.EntityInfo[] newArray(int size) {
            return new com.example.newnormal.data.models.EntityInfo[size];
        }
    };

...
public class SentimentInfo implements Parcelable {
    ...
    public static final Creator<SentimentInfo> CREATOR = new Creator<SentimentInfo>() {
        @Override
        public com.example.newnormal.data.models.SentimentInfo createFromParcel(Parcel in) {
            return new com.example.newnormal.data.models.SentimentInfo(in);
        }

        @Override
        public com.example.newnormal.data.models.SentimentInfo[] newArray(int size) {
            return new com.example.newnormal.data.models.SentimentInfo[size];
        }
    };
